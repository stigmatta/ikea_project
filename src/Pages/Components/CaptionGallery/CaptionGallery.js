    ...
    <div className='CaptionGallery' style = {{width:props.width}}>
      {props.images.map((img, index) => (
        <div key={index}>
          ...
          <div className="underTitle" style={{ width: '482px', marginTop: '20px' }}>Lorem ipsum dolor sit amet consectetur. Gravida convallis id orci egestas non. Rhoncus vitae quis sem.</div>
        </div>
      ))}
    </div>
  );
